...
public class Bug extends Incidence {
    ...
    public String getDetalle() {
        ...
        detalle.append("Bug ID: ").append(getNumeroId()).append("\n")
                .append("Nombre responsable: ").append(getNombre()).append("\n")
    ...
    public void cargarDatos() throws IOException {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Ingreso de datos cancelado por el usuario. Volviendo al menú principal.");
            throw e;
        }
    }
}
